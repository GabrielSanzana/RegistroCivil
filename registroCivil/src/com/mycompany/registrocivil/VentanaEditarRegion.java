...
import com.mycompany.excepciones.EditarRegionException;
...
public class VentanaEditarRegion extends javax.swing.JFrame {
    
    ConjuntoRegiones conjuntoRegiones;
    
    public VentanaEditarRegion(ConjuntoRegiones conjunto){
        this.conjuntoRegiones = conjunto;
        initComponents();
        comboBoxRegiones.addItem("Seleccione");
        EditarRegion.setEnabled(false);
        lblEditarRegion.setEnabled(false);
    ...
    private void initComponents() {
        ...
        lblBuscarRegion.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblBuscarRegion.setText("Buscar región");
        ...
        panelBuscarLayout.setHorizontalGroup(
            ...
            .addGroup(panelBuscarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(panelBuscarLayout.createSequentialGroup()
                    .addGap(16, 16, 16)
                    .addComponent(lblBuscarRegion, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panelBuscarLayout.setVerticalGroup(
            ...
            .addGroup(panelBuscarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(panelBuscarLayout.createSequentialGroup()
                    .addGap(10, 10, 10)
                    .addComponent(lblBuscarRegion, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
...
private Region region;
    private void btnBuscarMousePressed(java.awt.event.MouseEvent evt) throws EditarRegionException{//GEN-FIRST:event_btnBuscarMousePressed
        Object selectedItem = comboBoxRegiones.getSelectedItem();
        String selectedRegion = selectedItem.toString();
        if(selectedRegion.equals("Seleccione") == true)
        {
            casillaNombreDatos.setText("");
            casillaCantidad.setText("");
            editando=false;
            throw new EditarRegionException(selectedRegion);
        }
        
        editando = true;
        region = conjuntoRegiones.buscarRegion(selectedRegion);
        casillaNombreDatos.setText(region.getName());
        casillaCantidad.setText(String.valueOf(region.getCant()));
        casillaNombreDatos.setEnabled(true);
    ...
    private void btnGuardarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuardarMousePressed
        if(editando != true)
        {
            JOptionPane.showMessageDialog(null, "No se proporcionó una región válida para editar.", "Error", JOptionPane.ERROR_MESSAGE);
        }
        else
        {
            String nombre = casillaNombreDatos.getText();  
            if(nombre.equals(""))
            {
                casillaNombreDatos.setText(region.getName());
                comboBoxRegiones.setSelectedIndex(0);
            ...
            else if(conjuntoRegiones.buscarRegion(nombre) != null)
            {
                comboBoxRegiones.setSelectedIndex(0);
                casillaNombreDatos.setText(region.getName());
                JOptionPane.showMessageDialog(null, "Ya existe una región con ese nombre.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            editando = false;
            casillaNombreDatos.setText("");
            ...
            comboBoxRegiones.setSelectedIndex(0);
            File folderRegion = new File("CarpetaRegiones/" + nombre+".xls");
            File folderVotante = new File("CarpetaRegionesVotantes/" + nombre+".xls");
            folderRegion.delete();
            folderVotante.delete();
            conjuntoRegiones.exportarXlsTodasLasRegiones();
            conjuntoRegiones.exportarXlsVotantesTodasLasRegiones();
            JOptionPane.showMessageDialog(null, "Se ha editado exitosamente a la región", "Edición Exitosa", JOptionPane.INFORMATION_MESSAGE);
        }          
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEditarRegion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new VentanaEditarRegion(conjunto).setVisible(true);
            }
        });
    }
